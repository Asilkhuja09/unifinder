...
import { REGIONS, UNIVERSITIES, type Region, type University } from "@/data/extendedData";
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 py-16">
      ...
      <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
        ...
        acceptance rates, tuition, aid policy for internationals and campus multimedia.
      </p>
